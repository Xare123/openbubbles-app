...
and device observations below remain dated evidence, not fresh live state.
 ...
 Next (current September 25): dart-only run 36176609798 on 94dd841c7 is GREEN, 4009 passed, 0 failed, 5 skipped in 465s, plus 14 PowerShell contract and 3 evidence-output cases passed. All 3 prior failures pass. Composite with run 36166452770 app_rust 785/0 and binding checks on unchanged native/deps. Zero VMs and runners remain. Accepted slices (2274fb44f display, 10cca2362 worker retry) unchanged; live-app display stays OPEN.
