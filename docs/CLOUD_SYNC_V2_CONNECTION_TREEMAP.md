...
and device observations below remain dated evidence, not fresh live state.
 ...
 Next (current September 26): signed Canary staged from run 36203419397 on 94dd841c7 (workflow 1ff3a0cb8 success; producer sha256:0b5107417919e54d9467a7819a89ada5c4011fa5a20b6cc4f1d4e74379f1c5a6; signed artifact 441550769 bytes; v2 signature, canary package and engineering fingerprint enforced by the passing sign job). Zero VMs and runners remain. Pixel-ready means artifact plus plan ready, not installed or proven. Pixel plan (needs device/operation confirmation, no live action yet): confirm existing sign-in state without re-auth; open Profile encryption/PIN card and confirm readiness with no forced reset; run ordinary history sync and confirm readable chats plus media; restart and resume with no duplication or stranded locks. This can close ordinary read/projection/display/restart in the real app and PIN usability; it cannot close fresh sign-in, registration repair, production sends, independent Apple-client display or release readiness. Accepted slices (2274fb44f display, 10cca2362 worker retry) unchanged; live-app display stays OPEN until the Pixel session runs.
