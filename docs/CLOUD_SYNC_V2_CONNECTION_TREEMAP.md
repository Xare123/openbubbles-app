...
and device observations below remain dated evidence, not fresh live state.
 ...
 Next (current September 25): dart-only run 36174219761 on 0414d3342 completed with failure verdict 4006 passed, 3 failed, 5 skipped; PowerShell contract never ran by short-circuit. The 3 failures have concrete fixes on my branch at d5901b319 (dedicated semantics nodes plus scrollable card, completion-tail contract retracked with a behavioral clear assertion), not yet qualified. Zero VMs and runners remain. Accepted slices (2274fb44f display, 10cca2362 worker retry) unchanged; live-app display stays OPEN.
