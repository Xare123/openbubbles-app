...
and device observations below remain dated evidence, not fresh live state.
 ...
 Next (current September 26): signed Canary staged locally at C:/temp/canary/app-canary-debug.apk, 454158883 bytes, APK sha256:f1f77d369c90e9468b9f42ddf8ad091151aea9e2bfb050d367f59645d4e4bd2f (independently re-hashed, match). Provenance with archive versus APK hashes distinct: producer archive digest sha256:0b5107417919e54d9467a7819a89ada5c4011fa5a20b6cc4f1d4e74379f1c5a6, signed archive 441550769 bytes at digest sha256:f99087909b7e83dc137c9066a776ec8dcd6a7b87871a6dc46527693425807368. Package com.bluebubbles.messaging.cloudkitcanary, versionName 1.15.0, versionCode 20002227, target SDK 36; v2 and v3 signatures true with one signer at fingerprint 0ea17c1b67581ca79660d33db45af0a36b71ea36a4cbafec5293d3ae80570d79. Archive holds arm64-v8a, armeabi-v7a and x86_64 entries including flutter, rust_lib_bluebubbles, objectbox and native_lib. Local tooling available and executed: C:/Codex/Toolchains/AndroidSdk/build-tools/36.0.0/aapt2.exe, C:/Program Files/Microsoft/jdk-21.0.11.10-hotspot/bin/java.exe with apksigner.jar from the same build-tools dir. No device attached locally. Remaining device preflight: connect Pixel, confirm installed canary signer and version against staged values to rule out downgrade or data-clear, then run the recorded Pixel plan. Zero VMs and runners remain. Accepted slices (2274fb44f display, 10cca2362 worker retry) unchanged; live-app display stays OPEN until the Pixel session runs.
