...
| Qualified source / next candidate | Native `991b8379f38c35e3c2dfaa8a73308039cb9de0fd` is Windows-qualified. It resolves direct live-layout data, but the five sampled extensions now fail Icon/InvalidIcon. New source separates the metadata validator for the protector harness, repairs diagnostic vocabularies, and adds recognized raw-image byte routing plus gzip diagnostics. Those new changes are not yet qualified. |
...
| Current native qualification | Windows 34775816810 passed source `991b8379f`, pilot `2da3562ce`: 150 selected Rust tests, 620 Dart tests, 51 packaged-DLL codec cases. Parent verified 45 source inputs/12 logs/three ARM64 binaries and signed DLL `34c6ee5f80543614dd83f34d17e7db7bd15b668fe3817c6c0d333e9d7bf52af2`; 51 local codec cases passed under App Control. Its live replay applied zero new records, retained 6353, outbox 21 -> 21, all streams empty. |
| Next integration | Rerun full qualification after the observed Dart vocabulary and protector-build fixes. Then inspect actual icon encoding/trailing-data diagnostics and replay retained records. Raw PNG/JPEG/GIF/WebP routing is candidate compatibility support, not a claim that the sampled icons are those formats or that they render. Existing byte, expansion and gzip integrity limits remain. |
...
| Active retries / resume | Source `fccca0bb5325fb9e2f7ccc3cbd0902d428003aaa`, pilot `5fd8d03fe035e29ea79c906ca250a1dba3f5dcc1`: Windows 34779665447 (job 103784229966) and full GCE Canary 34779666716 (create job 103784232405) passed exact-source/config validation and are active. GCE primary lane, t2d-standard-60, us-west1-b; expected runner gce-34779666716-1, existing 75-minute lifetime. Preserve GitHub-hosted signing. Verify actual outcome artifact/final gate, source hashes, and cleanup before installing or declaring qualification. Never replace a still-live run after a polling timeout. |
