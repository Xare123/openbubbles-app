...
and device observations below remain dated evidence, not fresh live state.
 ...
 Next (current September 25): my-branch 2e0aa45f8 (awaited scoped persistence, stale-entry return, guarded background handler) and ed4bcff05 (keychain card compile/behavior fixes, V2 gate) answer the consolidated review; trusted branch untouched, no batch dispatched. Accepted slices (2274fb44f display, 10cca2362 worker retry) unchanged; live-app display stays OPEN.
