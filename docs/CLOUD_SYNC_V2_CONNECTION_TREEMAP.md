...
and device observations below remain dated evidence, not fresh live state.
 ...
 Next (current September 25): my-branch 807a548f2 (checked platform preference writes) and 846ee4e87 (terminal partial-success warning, stale test fix) answer the follow-up review; trusted branch untouched, no batch dispatched. Accepted slices (2274fb44f display, 10cca2362 worker retry) unchanged; live-app display stays OPEN.
