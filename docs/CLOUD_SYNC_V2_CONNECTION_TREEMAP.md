...
and device observations below remain dated evidence, not fresh live state.
 ...
 Next (current September 26): signed Canary staged locally at C:/temp/canary/app-canary-debug.apk with measured APK sha256:f1f77d369c90e9468b9f42ddf8ad091151aea9e2bfb050d367f59645d4e4bd2f. Provenance with archive versus APK hashes distinct: producer archive digest sha256:0b5107417919e54d9467a7819a89ada5c4011fa5a20b6cc4f1d4e74379f1c5a6, signed archive 441550769 bytes at digest sha256:f99087909b7e83dc137c9066a776ec8dcd6a7b87871a6dc46527693425807368; v2 signature, canary package and engineering fingerprint enforced by the passing sign job; arm64 libs include flutter, rust_lib_bluebubbles, objectbox and native_lib. Local version read needs device tooling and stays in device preflight. No device attached locally. Remaining device preflight: connect Pixel, confirm installed canary signer and version against staged values to rule out downgrade or data-clear, then run the recorded Pixel plan. Zero VMs and runners remain. Accepted slices (2274fb44f display, 10cca2362 worker retry) unchanged; live-app display stays OPEN until the Pixel session runs.
