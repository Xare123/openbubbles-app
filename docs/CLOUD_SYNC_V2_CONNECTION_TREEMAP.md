...
and device observations below remain dated evidence, not fresh live state.
 ...
 Next (current September 25): instrumented run 36166452770 on 846afec86 also hit the 60-minute cap, but the new partial-logs artifact isolated the stall: app_rust PASSED while Dart never finished. All 484 Dart errors are one root cause, a missing pushService import in the new keychain card, with compiler-crash fallout explaining the stall. Fixed in a9c3809dd on my branch, not yet qualified. Zero VMs and runners remain. Accepted slices (2274fb44f display, 10cca2362 worker retry) unchanged; live-app display stays OPEN.
