                  ...
                  child: Obx(() {
                    ...
                    return Container(
                      decoration: BoxDecoration(
                        color: !NavigationSvc.isAvatarOnly(context) && !showArchived && !showUnknown && !showDeleted
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            if (!NavigationSvc.isAvatarOnly(context) && !showArchived && !showUnknown && !showDeleted)
                              Expanded(
                                child: Row(
