...
List<Widget> buildSettingItemList({
  ...
  return [
    ...
    SearchableSettingItem(
      ...
      child: SettingsSection(
        ...
        children: [
          ...
          if (Platform.isAndroid && !usingRustPush) const SettingsDivider(),
          ...
          if (usingRustPush) const SettingsDivider(),
          if (usingRustPush)
            SearchableSettingItem(
              title: "Device Settings",
              searchTags: ["Hosted Device", "Device Settings"],
              onTap: () {
                ns.pushAndRemoveSettingsUntil(
                  context,
                  DevicePanel(),
              ...
              child: SettingsTile(
                backgroundColor: tileColor,
                title: SettingsSvc.settings.deviceIsHosted.value ? "Hosted Device" : "Device Settings",
                subtitle: "Manage this Apple device and related registration state",
                onTap: () {
                  ns.pushAndRemoveSettingsUntil(
                    context,
                    DevicePanel(),
    ...
    SearchableSettingItem(
      title: "Support",
      child: SettingsHeader(iosSubtitle: iosSubtitle, materialSubtitle: materialSubtitle, text: "Support"),
    ),
    SettingsSection(
      backgroundColor: tileColor,
      searchableSettingsItems: [
        ...
        if (!kIsWeb && (Platform.isAndroid || Platform.isWindows))
          SearchableSettingItem(
            ...
            child: SettingsTile(
              ...
              onTap: () async {
                await launchUrl(
                  Uri(scheme: "https", host: "openbubbles.app", path: "donate"),
        ...
        SearchableSettingItem(
          ...
          child: SettingsTile(
            ...
            onTap: () async {
              await launchUrl(
                Uri(scheme: "https", host: "discord.gg", path: "qUB3ksM3Ry"),
                mode: LaunchMode.externalApplication,
              );
            },
      ...
      SettingsSection(
        ...
        searchableSettingsItems: [
          if (usingRustPush)
            SearchableSettingItem(
              title: "Reconfigure",
              searchTags: ["Relog required", "Keep messages and reconfigure"],
              child: SettingsTile(
                backgroundColor: tileColor,
                onTap: () {
                  showDialog(
                      ...
                      return AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          TextButton(
                            ...
                            onPressed: () async {
                              Navigator.of(context, rootNavigator: true).pop();
                              PushSvc.markFailedToLogin(ui: true);
                            },
                          ),
                        ],
                      );
          ...
          if (usingRustPush)
            SearchableSettingItem(
              ...
              searchTags: ["Keep messages and change hardware"],
              child: SettingsTile(
                backgroundColor: tileColor,
                onTap: () {
                  showDialog(
                      ...
                      actions: <Widget>[
                        ...
                        TextButton(
                          ...
                          onPressed: () async {
                            ...
                            await PushSvc.markFailedToLogin(hw: false, logout: true, ui: true);
                        ...
                        TextButton(
                          ...
                          onPressed: () async {
                            ...
                            FilesystemSvc.deleteDB();
                            SocketSvc.forgetConnection();
                            await PushSvc.markFailedToLogin(hw: true, logout: true, ui: true);
                            SettingsSvc.settings = Settings();
                            await SettingsSvc.settings.saveAsync();
