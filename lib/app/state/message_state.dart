...
class MessageState extends StatefulController {
  ...
  final Rxn<DateTime> dateScheduled;
  final RxInt error;
  ...
  MessageState(this.message)
      : guid = RxnString(message.guid),
        ...
        dateScheduled = Rxn<DateTime>(message.dateScheduled),
  ...
  void updateDateScheduledInternal(DateTime? value) {
    if (dateScheduled.value != value) {
      dateScheduled.value = value;
      message.dateScheduled = value;
    }
  }
  ...
  void updateAssociatedMessageInfoInternal({
    ...
    if (associatedMessageEmoji != null && message.associatedMessageEmoji != associatedMessageEmoji) {
      message.associatedMessageEmoji = associatedMessageEmoji;
    }
  }
  ...
  void updateFromMessage(Message updatedMessage) {
    ...
    updateDateScheduledInternal(updatedMessage.dateScheduled);
    ...
    if (updatedMessage.associatedMessageGuid != null) {
      updateAssociatedMessageInfoInternal(
        ...
        associatedMessageEmoji: updatedMessage.associatedMessageEmoji,
      );
    }
    ...
    message.associatedMessageEmoji = updatedMessage.associatedMessageEmoji;
    message.verificationFailed = updatedMessage.verificationFailed;
    message.sendingServiceId = updatedMessage.sendingServiceId;
    message.amkSessionId = updatedMessage.amkSessionId;
    message.hasBeenForwarded = updatedMessage.hasBeenForwarded;
