...
export 'package:bluebubbles/objectbox.g.dart' if (dart.library.html) 'package:bluebubbles/models/html/objectbox.dart'
    hide Version;
...
export 'package:bluebubbles/database/io/giphy.dart' if (dart.library.html) 'package:bluebubbles/models/html/giphy.dart';
