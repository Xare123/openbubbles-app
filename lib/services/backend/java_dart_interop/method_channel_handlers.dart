...
abstract class MethodChannelServiceDelegate {
  ...
  RxList<Map<String, dynamic>> get simInfo;
}
...
class MethodChannelHandlers {
  MethodChannelHandlers(this.service) {
    _handlers = {
      ...
      MethodChannelInboundMethods.smsMessage: _handleSmsMessage,
      MethodChannelInboundMethods.apnMessage: _handleApnMessage,
      MethodChannelInboundMethods.extensionAddMessage: _handleExtensionAddMessage,
      MethodChannelInboundMethods.extensionUpdateMessage: _handleExtensionUpdateMessage,
      MethodChannelInboundMethods.extensionSetSuppress: _handleExtensionSetSuppress,
      MethodChannelInboundMethods.simInfo: _handleSimInfo,
    };
  }
  ...
  Future<bool> _handleSmsMessage(MethodCall call, Map<String, dynamic>? _) async {
    try {
      ...
      if (fromMe && PushSvc.disableOutgoingSms) return _ok();
  ...
  Future<bool> _handleApnMessage(MethodCall call, Map<String, dynamic>? _) async {
    try {
  ...
  Future<bool> _handleExtensionAddMessage(MethodCall _, Map<String, dynamic>? arguments) async {
    try {
  ...
  Future<bool> _handleExtensionUpdateMessage(MethodCall _, Map<String, dynamic>? arguments) async {
    try {
  ...
  Future<bool> _handleExtensionSetSuppress(MethodCall _, Map<String, dynamic>? arguments) async {
    try {
  ...
  Future<bool> _handleSimInfo(MethodCall _, Map<String, dynamic>? arguments) async {
    final info = (arguments?['info'] as List<dynamic>? ?? <dynamic>[])
        .map((e) => Map<String, dynamic>.from(e as Map))
        .toList();
    service.simInfo.assignAll(info);
    return _ok();
  }
}
