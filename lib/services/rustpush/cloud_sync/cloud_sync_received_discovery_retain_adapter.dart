...
/// on a lost commit response. Every attempt uses a fresh lookup. Not wired to
/// any caller yet.
        ...
        return await session.run((token) async {
          ...
          try {
            ...
            try {
              ...
              // A lost commit response after adoption reconciles through the
              // outer catch below: adopted work is never rolled back, and the
              // next attempt replays onto the already-owned change.
