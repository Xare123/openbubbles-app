...
abstract final class CloudSyncV2ReceivedArchiveSafeFailureCodes {
  static const all = <String>{
    ...
    'cloud_sync_received_archive_read_permit',
    'cloud_sync_received_archive_inspection_consumed',
    'cloud_sync_received_archive_inspection_expired',
    'cloud_sync_received_archive_inspection_disabled',
    ...
    'cloud_sync_received_archive_journal_required',
    'cloud_sync_received_archive_uploads_disabled',
    'cloud_sync_received_archive_found_projection_not_ready',
    'cloud_sync_received_archive_reader_busy',
    'received_found_reader_input_invalid',
    'received_found_reader_newer_evidence',
    'received_found_reader_outbox_unsettled',
    'cloud_sync_received_archive_parent_not_ready',
    'cloud_sync_received_archive_parent_changed',
    'cloud_sync_received_archive_record_mismatch',
    'cloud_sync_received_archive_readback_stage_failed',
    'cloud_sync_received_archive_observation_invalid',
    'cloud_sync_received_archive_observation_changed',
...
abstract final class CloudSyncV2CanonicalProjectionSafeFailureCodes {
  static const all = <String>{
    ...
    'canonical_extension_descendant_content_conflict',
    'canonical_extension_descendant_unproven',
    'canonical_extension_session_base_unavailable',
    'canonical_extension_session_content_unavailable',
    'canonical_extension_session_identity_conflict',
    'canonical_extension_session_predecessor_unavailable',
    'canonical_extension_session_predecessor_unproven',
...
const _cloudSyncV2SafeFailureCodes = <String>{
  ...
  'cloud_sync_windows_sender_identity_mismatch',
  'cloud_sync_windows_sender_auth_required',
  'cloud_sync_windows_sender_delegate_failed',
  'cloud_sync_windows_sender_delegate_missing',
  'cloud_sync_windows_sender_authentication_failed',
  ...
  'cloud_sync_windows_write_legacy_migration_forbidden',
  'cloud_sync_windows_write_legacy_preferences_present',
  'cloud_sync_windows_write_request_changed',
  'cloud_sync_windows_write_wire_invalid',
  'cloud_sync_windows_write_origin_invalid',
  'cloud_sync_windows_write_intent_missing',
  'cloud_sync_windows_write_send_unconfirmed_no_retry',
  'cloud_sync_windows_mutation_client_missing',
  'cloud_sync_windows_mutation_fresh_test_parent_required',
  'cloud_sync_windows_mutation_intent_missing',
  'cloud_sync_windows_mutation_parent_changed',
  'cloud_sync_windows_mutation_parent_invalid',
  'cloud_sync_windows_mutation_parent_readback_required',
  'cloud_sync_windows_mutation_receipt_changed',
  'cloud_sync_windows_mutation_receipt_cursor_repeated',
  'cloud_sync_windows_mutation_reflection_incomplete',
  'cloud_sync_windows_mutation_request_required',
  ...
  'cloud_sync_windows_mutation_source_invalid',
  'cloud_sync_windows_mutation_terminal_changed',
  'cloud_sync_windows_mutation_wire_invalid',
  'cloud_sync_windows_attachment_upload_unavailable',
  'cloud_sync_windows_attachment_upload_ambiguous',
  'cloud_sync_windows_attachment_upload_unconfirmed',
  'cloud_sync_windows_attachment_descriptor_invalid',
  ...
  'cloud_sync_windows_attachment_guid_invalid',
  ...
  'cloud_sync_local_send_chat_binding_changed',
  'cloud_sync_local_send_chat_journal_missing',
  'cloud_sync_outbound_chat_source_retired',
  'cloud_sync_outbound_chat_retirement_bound_exceeded',
  'cloud_sync_outbound_chat_retirement_invalid',
  'cloud_sync_outbound_chat_existing_history',
  'cloud_sync_chat_identity_scope_invalid',
  'cloud_sync_chat_identity_checkpoint_unready',
  ...
  'cloud_sync_chat_identity_tombstone_unresolved',
  'cloud_sync_chat_identity_source_incomplete',
  'cloud_sync_chat_identity_read_set_changed',
  'cloud_sync_chat_identity_candidate_invalid',
  'cloud_sync_chat_identity_candidate_changed',
  ...
  'cloud_sync_outbound_chat_origin_invalid',
  'cloud_sync_outbound_chat_generation_invalid',
  'cloud_sync_outbound_chat_origin_changed',
  'cloud_sync_outbound_chat_origin_ambiguous',
  'cloud_sync_outbound_chat_origin_scope_changed',
  'cloud_sync_outbound_chat_origin_row_conflict',
  'cloud_sync_outbound_chat_origin_missing',
  'cloud_sync_outbound_chat_origin_payload_changed',
  'cloud_sync_outbound_chat_origin_not_submitted',
  'cloud_sync_outbound_chat_origin_record_changed',
  'cloud_sync_outbound_chat_origin_malformed',
  'cloud_sync_outbound_chat_scope_invalid',
  'cloud_sync_outbound_chat_encoded_identity_changed',
  'cloud_sync_outbound_invalid_scope',
  'cloud_sync_outbound_invalid_request',
  'cloud_sync_outbound_unsupported_message',
  'cloud_sync_outbound_malformed_message',
  'cloud_sync_outbound_oversized_message',
  'cloud_sync_outbound_protected_storage',
  'cloud_sync_outbound_binding_mismatch',
  'cloud_sync_outbound_native_auth_unavailable',
  'cloud_sync_outbound_native_prepare_failed',
  ...
  'cloud_sync_attachment_parent_readback_pending',
  'cloud_sync_attachment_parent_readback_required',
  'cloud_sync_attachment_parent_upload_unresolved',
  'cloud_sync_attachment_plan_auth_changed',
  'cloud_sync_attachment_plan_busy',
  'cloud_sync_attachment_plan_client_invalid',
  'cloud_sync_attachment_plan_input_invalid',
  'cloud_sync_attachment_plan_inventory_incomplete',
  'cloud_sync_attachment_plan_inventory_invalid',
  'cloud_sync_attachment_plan_origin_changed',
  'cloud_sync_attachment_plan_stage_invalid',
  'cloud_sync_attachment_plan_store_invalid',
  ...
  'cloud_sync_attachment_upload_result_missing',
  ...
  'cloud_sync_attachment_source_unavailable',
  'cloud_sync_attachment_preparation_auth_unavailable',
  'cloud_sync_attachment_preparation_binding_changed',
  'cloud_sync_attachment_preparation_invalid',
  'cloud_sync_attachment_preparation_stage_failed',
  'cloud_sync_native_send_auth_unavailable',
  'cloud_sync_native_send_receipt_context_invalid',
  'cloud_sync_native_attachment_source_unavailable',
  'cloud_sync_native_attachment_source_invalid',
  'apply_network',
  'apply_throttled',
  'apply_server',
  'apply_authorization',
  ...
  'outbox_not_empty',
  'outbox_not_settled',
  'reset_rebootstrap_coordinator_active',
  'reset_rebootstrap_generation_mismatch',
  'local-storage',
  'malformed-response',
