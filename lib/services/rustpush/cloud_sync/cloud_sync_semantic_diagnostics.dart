...
abstract final class CloudSyncSemanticDiagnosticCodes {
  ...
  static const _exact = <String>{
    ...
    'canonical_chat_group_route_conflict',
    ...
    'canonical_message_edit_history_invalid_entry',
    'canonical_message_edit_history_writer_precision',
    'canonical_writer_precision_payload_ineligible',
    'canonical_writer_precision_local_ineligible',
    'canonical_writer_precision_current_content_mismatch',
    'canonical_writer_precision_sender_mismatch',
    'canonical_writer_precision_retracted',
    'canonical_writer_precision_history_ineligible',
    'canonical_writer_precision_history_mismatch',
