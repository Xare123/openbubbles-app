## 1.0.10+openbubbles.arm64.1

- Add explicit Windows ARM64 libmpv and ANGLE artifact selection.
- Pin all native archives by SHA-256 and reject unsupported Windows targets.
- Verify extracted DLL machine types before linking the plugin.
